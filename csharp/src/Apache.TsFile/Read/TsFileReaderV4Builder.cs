...
/// <summary>
/// Builder for creating TsFileReaderV4 instances.
/// Provides a fluent API for configuring TsFile v4 readers.
/// </summary>
public class TsFileReaderV4Builder
{
    ...
    public TsFileReaderV4Builder FilePath(string filePath)
    {
    ...
    /// <returns>This builder for method chaining.</returns>
    public TsFileReaderV4Builder File(FileInfo file)
    {
    ...
    /// <returns>This builder for method chaining.</returns>
    public TsFileReaderV4Builder WithEncryption(EncryptParameter encryptParameter)
    {
    ...
    /// <summary>
    /// Builds and returns a TsFileReaderV4 instance.
    /// </summary>
    /// <returns>A new TsFileReaderV4 configured with the specified options.</returns>
    public TsFileReaderV4 Build()
    {
        ValidateParameters();
        
        // Note: Encryption is not yet implemented in TsFileReaderV4.
        ...
        return new TsFileReaderV4(_filePath!);
    }
